...
<script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php
$query1 = "SELECT gender, SUM(amount) as numberone FROM members GROUP BY gender;";
...
?>
    ['<?php echo $services; ?>', '<?php echo $gender; ?>', <?php echo $numberone; ?>],
<?php
}
?>
<?php
$query10 = "SELECT quantity, SUM(amount) as numbert FROM equipment GROUP BY quantity;";
$res1000 = mysqli_query($con, $query10);

while ($data = mysqli_fetch_array($res1000)) {
    $expenses = 'Expenses';
    $quantity = $data['quantity']; // Assuming 'quantity' is the correct column name
    $numbert = $data['numbert'];
?>
    ['<?php echo $expenses; ?>', '<?php echo $quantity; ?>', <?php echo $numbert; ?>],
<?php
}
?>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa fa-coins"></i> Total Earnings: Ksh<?php include'income-count.php' ?></a> </li>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Francis Malombe</a> </div>
</div>
