...
<div id="content">
  ...
  <form role="form" action="index.php" method="POST">
            ...
            $password = md5($password);
                    ...
                    $qry = "INSERT INTO admin (name, username, password, email, address, designation, gender, contact, payrollno, nationalid, AccessMember, AccessEquipment, AccessAttendance, AccessCustomerprogress, AccessStatus, AccessPayment, AccessAnnouncement, AccessStaff, AccessAccounting, AccessReport)
VALUES ('$name', '$username', '$password', '$email', '$address', '$designation', '$gender', '$contact', '$payrollno', '$nationalid', '$AccessMember', '$AccessEquipment', '$AccessAttendance', '$AccessCustomerprogress', '$AccessStatus', '$AccessPayment', '$AccessAnnouncement', '$AccessStaff', '$AccessAccounting', '$AccessReport')";
