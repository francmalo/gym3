<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  ...
  <?php if($_SESSION["member"]==1){ ?>
    ...
    <li class="<?php if($page=='attendance'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-calendar-alt"></i> <span>Attendance</span></a>
      ...
      <?php if($_SESSION["customerprogress"]==1){ ?>
    ...
    <?php if($_SESSION["announcement"]==1){ ?>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-briefcase"></i> <span>Accounting</span> </span></a>
      <ul>
        <li class="<?php if($page=='income_page'){ echo 'active'; }?>"><a href="income_page.php"><i class="fas fa-arrow-right"></i> Income</a></li>
        <li class="<?php if($page=='expendicture'){ echo 'active'; }?>"><a href="expendicture_page.php"><i class="fas fa-arrow-right"></i> Expenditure</a></li>
     <?php } ?>
