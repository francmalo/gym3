<?php
session_start();
if(!isset($_SESSION['user_id']) && ($_SESSION['add-equip'])==0){
...
<html lang="en">
<head>
<title>Gym System Admin</title>s
<meta charset="UTF-8" />
...
$qry = "insert into equipment(name,description,amount,vendor,address,contact,date,quantity,status) values ('$name','$description','$totalamount','$vendor','$address','$contact','$date','$quantity','$status')";
